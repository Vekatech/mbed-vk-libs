...
#if     defined(MBED_CONF_LCD_BOARD) && ((LCD_VDC5_CH0_PANEL == PANEL_NONE) || (LCD_VDC5_CH0_PANEL == PANEL_VKLCD50RTA) || (LCD_VDC5_CH0_PANEL == PANEL_VKLCD70RT) || (LCD_VDC5_CH0_PANEL == PANEL_VKLVDS_HDMI))
...
#endif  /* LCD_VDC5_CH0_PANEL == PANEL_VKLCD50RTA / PANEL_VKLCD70RT / PANEL_VKLVDS_HDMI */
