...
#define     LCD_CH0_DISP_HSYNC      (0u)                		/* Hsync width */
...
#define     LCD_CH0_DISP_VSYNC      (0u)                		/* Vsync width */
#define     LCD_CH0_SIG_FV          (635u)                      /* Free-running Vsync period */
#define     LCD_CH0_SIG_FH          (1344u)                     /* Hsync period */
...
#define     LCD_CH0_IOEXP_ADDR      0x4E

/******************************************************************************
Typedef definitions
******************************************************************************/

#define LVDS_IIC_SCL            P1_6
#define LVDS_IIC_SDA            P1_7

#define IOEXP_REG_E_EDID_DATA   0x00
#define IOEXP_REG_IO_DATA       0x80
#define IOEXP_REG_CALIB_DATA    0x90
