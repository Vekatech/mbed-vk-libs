...
#ifndef LCD_NONE_CH0_H
#define LCD_NONE_CH0_H
...
#define     LCD_CH0_SIG_FV          (288u)                      /* Free-running Vsync period */
#define     LCD_CH0_SIG_FH          (525u)                      /* Hsync period */
