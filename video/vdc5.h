...
/* video controller channel select */
typedef enum {
    DRV_CH_0 = 0,      /* video controller channel 0    */
    DRV_CH_1           /* video controller channel 1    */
} drv_ch_t;
...
drv_graphics_error_t DRV_Graphics_Irq_Handler_Set( drv_ch_t drv_ch, vdc5_int_type_t irq, uint16_t num, void (* callback)(vdc5_int_type_t)  );
