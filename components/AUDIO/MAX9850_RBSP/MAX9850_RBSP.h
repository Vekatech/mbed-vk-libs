...
#ifndef MBED_MAX9850_RBSP_H
#define MBED_MAX9850_RBSP_H

#include "mbed.h"
#include "AUDIO_RBSP.h"
#include "R_BSP_Ssif.h"

/** MAX9850_RBSP class, defined on the I2C master bus
*
*/
class MAX9850_RBSP : public AUDIO_RBSP {
public:

    /** Create a MAX9850_RBSP object defined on the I2C port
     * 
     ...
     */
    MAX9850_RBSP(PinName sda, PinName scl, PinName sck, PinName ws, PinName tx, PinName rx, uint8_t int_level = 0x80, int32_t max_write_num = 16, int32_t max_read_num = 16);

    virtual ~MAX9850_RBSP() {}
...
protected:
    char cmd[4];    // the address and command for MAX9850 internal registers
